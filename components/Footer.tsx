...
export default async function Footer() {
  // Sabhi settings ek sath fetch karo
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-16 border-b border-[#322724]/60">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-3 text-sm">
              <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[#A3958E] hover:text-[#C89A84] transition-colors">
                <span className="w-4 h-4 text-[#C89A84] font-bold">IG</span>
                <span>Instagram</span>
              </a>
              <a href={`https://wa.me/${whatsappNum}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[#A3958E] hover:text-[#C89A84] transition-colors">
                <span className="w-4 h-4 text-[#C89A84] font-bold">WA</span>
                <span>WhatsApp</span>
              </a>
              <a href={`mailto:${supportEmail}`} className="flex items-center gap-3 text-[#A3958E] hover:text-[#C89A84] transition-colors">
