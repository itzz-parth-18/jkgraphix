  ...
  return (
    <div className="min-h-screen bg-[#F9F6F2] text-[#2C2320] flex flex-col">
      ...
      <main className="flex-grow max-w-4xl mx-auto px-6 py-16 space-y-6">
        <h1 className="font-serif text-3xl font-bold text-[#1F1816]">Frequently Asked Questions</h1>
        <p className="text-[#6E625C]">Find answers regarding custom memory boxes, engraving previews, and workshop processing times.</p>
      </main>
    </div>
  );
}