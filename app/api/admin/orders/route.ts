...
// GET: Fetch all incoming orders using exact schema structure
export async function GET() {
  try {
    ...
    const formattedOrders = dbOrders.map((order) => {
      ...
      // Extracting photos precisely from the customizations JSON field
      let photos: string[] = [];
      ...
      return {
        ...
        category: "Memory Boxes", // Default category fallback since product doesn't store category string directly
...
// PATCH: Update order status based on Prisma OrderStatus enum
