...
import { 
  ...
  Image as ImageIcon, CheckCircle2, Clock, AlertCircle, Star 
} from "lucide-react";
    ...
    <div className="space-y-8 p-6 md:p-8 bg-[#F9F6F2] min-h-screen text-[#2C2320]">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#6E625C]">Manage your catalog, custom options, inventory, and visibility.</p>
        </div>
        <Link
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-[#EFE8E2] text-sm">
              {loading ? (
                <tr>
                  <td colSpan={7} className="py-12 text-center text-[#6E625C]">Loading product catalog...</td>
                </tr>
              ) : filteredProducts.length === 0 ? (
                <tr>
                  <td colSpan={7} className="py-12 text-center text-[#6E625C]">No products found matching your search.</td>
                </tr>
              ) : (
